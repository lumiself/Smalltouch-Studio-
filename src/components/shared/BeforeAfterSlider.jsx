  ...
  return (
    ...
    >
      {beforeSrc ? (
        ...
        <div className="w-full h-full bg-[#242424] flex items-center justify-center text-[#a3a3a3] text-xs">Before</div>
      )}
      ...
      <div className="absolute inset-0 overflow-hidden" style={{ clipPath: `inset(0 ${100 - position}% 0 0)` }}>
        {afterSrc ? (
          ...
          <div className="w-full h-full bg-[#1a1a1a] flex items-center justify-center text-[#a3a3a3] text-xs">After</div>
        )}
      </div>
